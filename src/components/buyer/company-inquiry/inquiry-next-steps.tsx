const steps = [
  ...
  "They review your requirement",
  "They contact you with details",
];

export function InquiryNextSteps() {
  return (
    <div className="rounded-[10px] border border-[#e1e2ed] bg-gradient-to-br from-white to-[#f5f3ff] p-4 sm:p-5">
      ...
      <div className="mt-5 space-y-5">
        {steps.map((step, index) => (
          ...
          >
            ...
            <p className="font-medium text-[#454a70] text-[10px]">
              {step}
            </p>
          </div>
        ))}
