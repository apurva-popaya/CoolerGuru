...
export function BuyerDashboardOverview() {
  ...
  return (
    <section className="px-8 py-7">
      <h1 className="font-bold text-[#171570] text-[27px]">Dashboard Overview</h1>
      ...
      <div className="relative mt-5 flex min-h-[145px] items-center overflow-hidden rounded-[9px] border border-[#dedff0] bg-gradient-to-r from-[#f8f6ff] to-[#f2f0ff] px-6">
        <div className="flex h-[58px] w-[58px] shrink-0 items-center justify-center rounded-full bg-white/70 text-[#392ada]">
          <BarChart3 size={26} />
        </div>

        <div className="ml-5">
          <h2 className="font-bold text-[#171570] text-[22px]">Welcome back, Buyer!</h2>

          <p className="mt-2 max-w-[360px] text-[#565b75] text-[10px] leading-[1.5]">
        ...
        <Link
          href="/products"
          className="!text-white ml-auto flex h-[42px] min-w-[165px] items-center justify-center gap-3 rounded-[5px] bg-[#2116a5] px-5 font-bold text-[10px] transition hover:bg-[#3022c6]"
        >
          Browse Products
          <ArrowRight size={14} />
        </Link>
      ...
      <BuyerDashboardStats totalInquiries={summary.total} recentInquiries={summary.recent_30_days} loading={loading} />
