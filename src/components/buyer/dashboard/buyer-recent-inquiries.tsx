    ...
    <div className="mt-5 overflow-hidden rounded-[9px] border border-[#e1e2ed] bg-white">
      <div className="flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
        ...
        <Link
          ...
          className="!text-[#2519c9] font-bold text-[9px]"
        >
          View All Inquiries →
        </Link>
      </div>
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[700px]">
          ...
          {loading ? (
            <div className="px-4 py-8 text-center text-[#686d84] text-[9px]">
            ...
            inquiries.map((inquiry) => (
              ...
              >
                <div className="min-w-0">
                  <p className="truncate font-bold text-[#171570] text-[10px]">
                ...
                <p className="truncate pr-4 text-[#454a67] text-[9px]">
