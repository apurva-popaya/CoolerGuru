...
const items = [
  {
    ...
    description: "Build trust with your verified business profile",
    icon: ShieldCheck,
  },
  {
    title: "Quality Inquiries",
    description: "Receive genuine inquiries from verified buyers",
    icon: UsersRound,
  },
  {
    title: "Grow Business",
    description: "Increase visibility and grow your sales",
    icon: BarChart3,
  },
  {
    title: "Dedicated Support",
    description: "Get help from our supplier support team",
    icon: Headphones,
  },
];

export default function SupplierLoginBenefits() {
  return (
