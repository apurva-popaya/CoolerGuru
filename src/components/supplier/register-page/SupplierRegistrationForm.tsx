...
import {
  sendSupplierRegistrationOtp,
  verifySupplierRegistrationOtp,
...
export default function SupplierRegistrationForm() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await sendSupplierRegistrationOtp(mobile);
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const response = await verifySupplierRegistrationOtp(mobile, otpValue);
    ...
    <section className="bg-gradient-to-br from-[#f8f9ff] via-white to-[#f2f4ff] px-4 py-9">
      <Container>
        <div className="text-center">
          <h1 className="font-bold text-[#171570] text-[30px]">Registration</h1>

          <p className="mt-2 font-medium text-[#4e5472] text-[11px]">
            Join CoolerGuru and grow your business with verified buyers
          </p>
        </div>
        ...
        <div className="mx-auto mt-6 max-w-[620px] overflow-hidden rounded-[10px] border border-[#e4e5ef] bg-white shadow-[0_14px_40px_rgba(40,35,120,0.08)]">
          <div className="border-[#e4e5ef] border-b px-6 py-5 text-center">
            <h2 className="font-bold text-[#2a20c4] text-[17px]">Mobile Verification</h2>
          </div>
          ...
          <div className="px-10 py-8">
            ...
            <div className="mt-5 text-center">
              <h3 className="font-bold text-[#171570] text-[19px]">Verify Your Mobile Number</h3>

              <p className="mx-auto mt-2 max-w-[360px] font-medium text-[#555b78] text-[10px] leading-[1.55]">
                Enter your mobile number to receive OTP and create your supplier account.
              </p>
            </div>

            <div className="mt-8">
              <label htmlFor="supplier-register-mobile" className="font-bold text-[#171570] text-[10px]">
                Mobile Number
              ...
              <p className="mt-2 text-[#646984] text-[8px]">
                We will send you a One Time Password (OTP) on this number
              </p>
            </div>
            ...
            {!otpSent ? (
              ...
              <>
                ...
                <button
                  ...
                  disabled={!otpComplete || verifyingOtp || sendingOtp}
            ...
            <p className="text-center font-medium text-[#444a6a] text-[10px]">
              ...
              <Link href="/supplier/login" className="!text-[#2b21c6] font-bold hover:underline">
                Login here
              </Link>
            </p>
