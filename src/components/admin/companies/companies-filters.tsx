    ...
    <div className="space-y-3">
      <FilterBar>
        ...
        >
          ...
          <SelectContent>
            {companyFilterOptions.verificationStatus.map(
              (option) => (
                <SelectItem
                  key={option}
                  value={option}
        ...
        >
          ...
          <SelectContent>
            {companyFilterOptions.businessType.map(
              (option) => (
                <SelectItem
                  key={option}
                  value={option}
        ...
        >
          ...
          <SelectContent>
            {companyFilterOptions.location.map(
              (option) => (
                <SelectItem
                  key={option}
                  value={option}
        ...
        >
          ...
          <SelectContent>
            {companyFilterOptions.featured.map(
              (option) => (
                <SelectItem
                  key={option}
                  value={option}
      ...
      <div className="flex flex-wrap items-center gap-2 px-1">
        <span className="mr-1 font-medium text-[#5d6280] text-[12px]">
          Quick Filters:
        </span>
